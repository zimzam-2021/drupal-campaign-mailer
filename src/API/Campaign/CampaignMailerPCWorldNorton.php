...
class CampaignMailerPCWorldNorton
{
    ...
    public function createSMTPConnection($debug = false)
    {
    ...
    public function generateMailBody($to, $toName = null, $dummy = false)
    {
        ...
        $completeMessage =
            ...
            "<p> If you like to cancel of modify this order please call on <b>$phoneno</b> [Local time 9AM to 7PM (Monday to Saturday)] or reply your contact no 
            where our executive can call and confirm cancellation of the order. 
            This is important to cancel the order and refund the amount.</p>".
