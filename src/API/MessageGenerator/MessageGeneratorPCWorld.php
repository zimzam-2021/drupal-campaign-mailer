...
class MessageGeneratorPCWorld
{
    ...
    public function chargeLine()
    {
        $chargelines = [
            ...
            'We wil ne charge ::amount for the same. ',
            'A amount of ::amount will be deducted from you.',
            'Charges of ::amount will be deducted from you.',
            'You will be charged for ::amount.',
            'You will be charged for an amount of ::amount.',
            'Total charges amouting to ::amount will be deducted from you.',
            'We have charged a fee of ::amount for the same. ',
            'A fee of ::amount has been deducted from you.',
            'Fees of ::amount has been deducted from you.',
            'You have been charged for a fee of ::amount.',
            'You have been charged for an fee of ::amount.',
            'Total fee amouting to ::amount has been deducted from you.',
            'We wil be fee ::amount for the same. ',
            'A fee of ::amount will be deducted from you.',
            'Fees of ::amount will be deducted from you.',
            'You will be charged for a fee of ::amount.',
            'You will be charged for a fee of::amount.',
            'Total fees amouting to ::amount will be deducted from you.'
